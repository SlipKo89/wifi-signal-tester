...
В приложении также есть **отдельный инструмент диагностики LTE** для роутеров
MikroTik с модемом. Он читает качество радиоканала через REST, бинарный API или
SSH и никак не смешивается с Wi-Fi-дашбордом.
